...
def pid_locomotive():
    ...
    plt.savefig('pid_locomotive_Kp.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.savefig('pid_locomotive_Kd.png', dpi=300, bbox_inches='tight')
    plt.show()
    env.close()
    ...
    plt.savefig('pid_locomotive_Ki.png', dpi=300, bbox_inches='tight')
    plt.show()
    env.close()
